...
Kernel_Add = [{'Arch': 'x86_64', 'BundlePath': 'Lilu.kext', 'Comment': 'Patch engine', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/Lilu', 'MaxKernel': '', 'MinKernel': '10.0.0', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'x86_64', 'BundlePath': 'VirtualSMC.kext', 'Comment': 'SMC emulator', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/VirtualSMC', 'MaxKernel': '', 'MinKernel': '10.0.0', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'Any', 'BundlePath': 'NVMeFix.kext', 'Comment': '', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/NVMeFix', 'MaxKernel': '', 'MinKernel': '', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'Any', 'BundlePath': 'SMCProcessor.kext', 'Comment': '', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/SMCProcessor', 'MaxKernel': '', 'MinKernel': '', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'Any', 'BundlePath': 'SMCSuperIO.kext', 'Comment': '', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/SMCSuperIO', 'MaxKernel': '', 'MinKernel': '', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'x86_64', 'BundlePath': 'WhateverGreen.kext', 'Comment': 'Video patches', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/WhateverGreen', 'MaxKernel': '', 'MinKernel': '12.0.0', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'x86_64', 'BundlePath': 'AppleALC.kext', 'Comment': 'Audio patches', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/AppleALC', 'MaxKernel': '', 'MinKernel': '12.0.0', 'PlistPath': 'Contents/Info.plist'}, {'Arch': 'x86_64', 'BundlePath': 'IntelMausi.kext', 'Comment': 'Intel Ethernet LAN', 'Enabled': True, 'ExecutablePath': 'Contents/MacOS/IntelMausi', 'MaxKernel': '', 'MinKernel': '', 'PlistPath': 'Contents/Info.plist'}]
...
with open('tmp/EFI/OC/config.plist','rb') as f:
    ...
    r['NVRAM']['Add']['7C436110-AB2A-4BBB-A880-FE41995C9F82']['boot-args'] = 'agdpmod=pikera igfxfw=2 shikigva=16 debug=0x100 keepsyms=1 alcid=1 brcmfx-country=HK brcmfx-aspm'
    r['NVRAM']['Add']['7C436110-AB2A-4BBB-A880-FE41995C9F82']['prev-lang:kbd'] = b''
    r['NVRAM']['Add']['7C436110-AB2A-4BBB-A880-FE41995C9F82']['csr-active-config'] = b'g\x00\x00\x00' #bytearray.fromhex('67000000') 
    r['NVRAM']['Delete']['7C436110-AB2A-4BBB-A880-FE41995C9F82'] = ["boot-args","ForceDisplayRotationInEFI","csr-active-config"]
    ...
    r['Misc']['Boot']['HideAuxiliary'] = True
